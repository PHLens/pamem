...
export function onboardUsage() {
  console.log(`Usage: pamem onboard <workspace> [--agent-home] [--profile <onboarding|coder|reviewer|researcher|wiki>] [--runtime <cli|slock>] [--agent-id <id>] [--memory-repo <path>] [--sync-remote <target>] [--sync-ref <ref>] [--sync-executor <name>] [--force]
...
function parseValueOption(arg, args, index) {
  const names = ['--profile', '--runtime', '--agent-id', '--memory-repo', '--sync-remote', '--sync-ref', '--sync-executor'];
